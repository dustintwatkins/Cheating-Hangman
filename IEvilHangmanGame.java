...
public interface IEvilHangmanGame {
	 ...
	 * @throws hangman.evilHangmanGame.GuessAlreadyMadeException 
	 */
	public Set<String> makeGuess(char guess) throws GuessAlreadyMadeException, hangman.evilHangmanGame.GuessAlreadyMadeException;
